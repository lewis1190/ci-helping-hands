...
-   **Codebase-wide Validation**: When I was nearing the completion of my MVP, I asked Copilot to scan my entire codebase for any common mistakes, like incorrect semantics of HTML elements, and inconsistent / redundant CSS classes. Copilot provided me with a list of potential issues, and offered to fix them for me. I applied and tested each change one at a time to ensure nothing broke, and never let it add any HTML or CSS that I didn't fully understand.
-   **Codebase-wide Repetitive Tasks**: When I had created all of the individual pages and content for the site, I needed to ensure all of my navigation links were correct across every page. I used Copilot to scan my codebase and update all of the `<nav>` and `<a>` elements to ensure that the everything clickable led to the right area. This saved a huge amount of time compared to manually correcting **EVERY** nav link in **EVERY** navbar in **EVERY** file.
